	...
	[0], {
		...
		113: function(e, t, r) {
				...
				return Object(u.jsxs)("div", {
					children: [Object(u.jsx)(f.a, {
						children: Object(u.jsxs)(g.a, {
							...
							color: "textSecondary",
							align: "center",
							children: ["\xa9 ", Object(u.jsx)(Fe.a, {
								color: "inherit",
								href: pe.c.url,
			...
			var Pe = function() {
				...
				Ve = Boolean("localhost" === window.location.hostname || "[::1]" === window.location.hostname || window.location
				...
				navigator.serviceWorker.register(e).then((function(e) {
					e.onupdatefound = function() {
						...
						null != r && (r.onstatechange = function() {
							"installed" === r.state && (navigator.serviceWorker.controller ? (console.log(
								"New content is available and will be used when all tabs for this page are closed. See https://cra.link/PWA."
							), t && t.onUpdate && t.onUpdate(e)) : (console.log("Content is cached for offline use."), t && t.onSuccess &&
								t.onSuccess(e)))
						})
					}
				})).catch((function(e) {
						...
						window.addEventListener("load", (function() {
							...
							Ve ? (! function(e, t) {
								fetch(e, {
									...
									404 === r.status || null != n && -1 === n.indexOf("javascript") ? navigator.serviceWorker.ready.then(
										(function(e) {
		...
		38: function(e) {
			e.exports = JSON.parse(
				'{"b":"\u4e91\u7a7a\u8c03\uff0c\u4fbf\u643a\u5c0f\u7a7a\u8c03","a":{"url":"https://www.yunyoujun.cn","email":"me@yunyoujun.cn","name":"YunYouJun"},"c":{"type":"git","url":"https://github.com/YunYouJun/air-conditioner"}}'
			)
		}
	},
	[
